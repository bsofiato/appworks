...
/**
 * <p>Factory of cloning strategies.</p>
 *
 * <p>Based on a supplied type, creates a cloning strategy reflecting the 
 * supplied type cloning semantics.</p>
 * 
 * @author Bruno Sofiato
 */
public interface CloningStrategyFactory {
  ...
  <Type> CloningStrategy <Type> create(Class <Type> klass);
}
