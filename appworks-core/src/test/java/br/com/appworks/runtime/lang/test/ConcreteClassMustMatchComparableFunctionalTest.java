...
public class ConcreteClassMustMatchComparableFunctionalTest extends TestCase {
  @br.com.appworks.runtime.lang.Comparable(concreteClassesMustMatch = true)
  ...
  public ConcreteClassMustMatchComparableFunctionalTest(String testName) {
    super(testName);
  }
  ...
  public void testBaseBeanChildBean1OperandsCompareTo() {
    BaseBean op1 = new BaseBean("X");
    ChildBean1 op2 = new ChildBean1("X");
    assertTrue(0 > ((java.lang.Comparable)(op1)).compareTo(op2));
    assertTrue(0 < ((java.lang.Comparable)(op2)).compareTo(op1));  
  }
